...
<c:forEach items="${dealHistory}" var="item" varStatus="status">
<tr>
	...
	<td><a href="ratetransporter?tid=${item.transporter.username }&did=${item.deal_id}&tk=${tokens[status.index]}">Give Rating</a></td>
